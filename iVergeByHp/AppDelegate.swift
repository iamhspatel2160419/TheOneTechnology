...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        GMSServices.provideAPIKey("AIzaSyCKZuORYmQnv4MKbMM13LBqyquEyRL3L3Y")
        GMSPlacesClient.provideAPIKey("AIzaSyCKZuORYmQnv4MKbMM13LBqyquEyRL3L3Y")
    ...
    func deleteIterm()
    {
        ...
        let dbUrl = supportDirectory.appendingPathComponent("iVergeByHp.sqlite")
        print("dbUrl",dbUrl)
        do {
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        let modelURL = Bundle.main.url(forResource: "iVergeByHp", withExtension: "momd")
        print(modelURL ?? "")
        return NSManagedObjectModel(contentsOf: modelURL!)!
    }()
    lazy var persistentContainer: NSPersistentContainer = {
        let container = NSPersistentContainer(name: "iVergeByHp")
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator = {
        ...
        let supportDirectory = FileManager.default.urls(for: .documentDirectory, in: .userDomainMask).first!
        let url = supportDirectory.appendingPathComponent("iVergeByHp.sqlite")
        print(url)
